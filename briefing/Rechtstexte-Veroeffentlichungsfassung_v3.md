...
Umsatzsteuer-Identifikationsnummer gemäß § 27a UStG: DE363826204

## Berufshaftpflichtversicherung

Baloise Sachversicherung AG Deutschland, Basler Straße 4,
61352 Bad Homburg v.d.H.

Geltungsraum: Deutschland sowie weltweit bei vorübergehenden
Auslandsaufenthalten bis zu einem Jahr.

## Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV

David Liebnau, Anschrift wie oben
...
Gesetzen bleiben davon unberührt. Eine diesbezügliche Haftung ist erst ab dem
Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung möglich. Bei
Bekanntwerden entsprechender Rechtsverletzungen entferne ich diese Inhalte
umgehend.
...
Anbieter verantwortlich. Die verlinkten Seiten wurden zum Zeitpunkt der
Verlinkung auf mögliche Rechtsverstöße überprüft, rechtswidrige Inhalte waren
nicht erkennbar. Eine dauerhafte inhaltliche Kontrolle ist ohne konkrete
...
Art der Verwertung außerhalb der Grenzen des Urheberrechts bedürfen meiner
...
dieser Seite nicht von mir erstellt wurden, werden die Urheberrechte Dritter
beachtet und als solche gekennzeichnet.
...
88 Colin P Kelly Jr Street, San Francisco, CA 94107, USA, einem
Tochterunternehmen der Microsoft Corporation.

Beim Aufruf der Website erhebt GitHub automatisch Daten, die dein Browser
übermittelt. Dazu gehören IP-Adresse, Datum und Uhrzeit des Zugriffs, die
aufgerufene Seite, der verwendete Browser und das Betriebssystem. Diese
Verarbeitung ist technisch erforderlich, um die Website auszuliefern.
...
Da GitHub seinen Sitz in den USA hat, findet eine Übermittlung in ein
Drittland statt. GitHub ist unter dem EU-US Data Privacy Framework
zertifiziert.
...
Wenn du mich per E-Mail kontaktierst, verarbeite ich deine Angaben zur
Bearbeitung deiner Anfrage und für den Fall von Anschlussfragen. Diese Daten
gebe ich nicht ohne deine Einwilligung weiter.

Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO, wenn die Anfrage mit einem
Vertrag oder dessen Anbahnung zusammenhängt, sonst Art. 6 Abs. 1 lit. f
DSGVO.

Ich lösche diese Daten, sobald der Zweck entfallen ist, spätestens nach
Ablauf der gesetzlichen Aufbewahrungsfristen.

## 5. Daten im Rahmen von Programmen und Coachings
...
Diese Website verlinkt auf externe Angebote, unter anderem auf Spotify, Apple
Podcasts, LinkedIn und light-creators.com. Beim Anklicken dieser Links
verlässt du diese Website. Für die Datenverarbeitung auf den verlinkten
Seiten gelten die dortigen Datenschutzbestimmungen.
...
Datenübertragbarkeit und auf Widerspruch gegen die Verarbeitung. Eine
erteilte Einwilligung kannst du jederzeit für die Zukunft widerrufen.

Außerdem steht dir ein Beschwerderecht bei einer Aufsichtsbehörde zu.
Zuständig ist die Berliner Beauftragte für Datenschutz und
Informationsfreiheit, Alt-Moabit 59-61, 10555 Berlin.

## 9. Änderungen

Ich passe diese Datenschutzerklärung an, wenn sich die Rechtslage oder die
Technik dieser Website ändert. Es gilt jeweils die hier veröffentlichte
Fassung.
...
mit vertraulichen Themen arbeite, halte ich mich dabei an feste Regeln.

**Nichts Vertrauliches geht in ein KI-System.**
Was in einem Coaching, in einem Führungsteam oder in einer Gruppe gesagt
wird, gebe ich nicht in KI-Systeme ein. Das gilt für Namen, für Situationen,
für Aufzeichnungen und für alles, woraus sich eine Person oder ein
Unternehmen erkennen ließe. Wenn ich in einem Beispiel aus meiner Praxis
erzähle, ist es so verändert, dass niemand darin wiederzufinden ist, und ich
hole vorher die Zustimmung der betroffenen Person ein.

**Die Verantwortung bleibt bei mir.**
Was KI beiträgt, prüfe ich, bevor es jemanden erreicht. Für jedes Ergebnis
stehe ich persönlich ein, unabhängig davon, welches Werkzeug daran beteiligt
war.

**Über Menschen entscheidet kein System.**
Wer an einem Programm teilnimmt, wie ein Gespräch verläuft und was ich
jemandem empfehle, entscheide ich selbst. Kein KI-System bewertet Menschen,
trifft Auswahlentscheidungen oder erstellt Profile.

**Im Raum bleibt der Raum frei.**
In Coachings, Workshops und Programmen läuft keine KI mit. Keine automatische
Aufzeichnung, keine Analyse im Hintergrund, keine Auswertung von Gesagtem. Wo
...
AI Acts. Beides entwickelt sich weiter, meine Praxis entsprechend auch.
...
Der Ablauf: Du bewirbst dich formlos. Es folgt ein Gespräch. Wenn wir beide
zusagen, erhältst du von mir eine Anmeldebestätigung in Textform mit allen
...
Bei The Threshold Program sind enthalten: die Begleitung während der sechs
Tage, Unterkunft und Verpflegung vor Ort, alle Programmmaterialien sowie die
Begleitung über sechs Wochen nach dem Programm.

Nicht enthalten sind An- und Abreise, Reise- und Krankenversicherungen sowie
persönliche Ausrüstung und Kleidung.

Ich schulde eine sorgfältige, fachlich fundierte Durchführung, keinen
...
Mit der Anmeldebestätigung wird eine Anzahlung in Höhe von 20 Prozent des
Programmpreises fällig, zahlbar innerhalb von 14 Tagen nach Rechnungserhalt.
Mit Eingang der Anzahlung ist dein Platz verbindlich reserviert.

Der Restbetrag ist spätestens 30 Tage vor Programmbeginn fällig. Bei
Anmeldungen, die weniger als 30 Tage vor Programmbeginn erfolgen, ist der
...
Anmeldebestätigung erhältst und die auch unter davidliebnau.com/widerruf/
abrufbar ist.

Solange die Widerrufsfrist läuft, geht das Widerrufsrecht den
...
|---|---|
| bis 60 Tage vor Beginn | 20 Prozent, also die Anzahlung |
| 59 bis 30 Tage vor Beginn | 50 Prozent |
| ab 29 Tage vor Beginn | 90 Prozent |

Du kannst stattdessen jederzeit eine Ersatzperson benennen, sofern diese die
Teilnahmevoraussetzungen erfüllt und ein Bewerbungsgespräch geführt hat. In
diesem Fall fällt lediglich eine Bearbeitungspauschale von 50 Euro an.

Es steht dir frei nachzuweisen, dass mir kein oder ein wesentlich geringerer
Schaden entstanden ist. In diesem Fall reduzieren sich die Stornokosten
entsprechend.
...
erstatte ich gezahlte Beträge vollständig.
...
Du nimmst eigenverantwortlich teil und triffst deine Entscheidungen während
des Programms selbst. Bestehende Erkrankungen, Medikamenteneinnahme oder
Einschränkungen, die für die Teilnahme erheblich sein können, teilst du mir
vor Programmbeginn mit.

Bei laufender ärztlicher oder psychotherapeutischer Behandlung wegen einer
körperlichen oder psychischen Erkrankung bitte ich um eine Bescheinigung der
behandelnden Person über die Teilnahmefähigkeit.

Das Programm ist Selbsterfahrung und Entwicklungsarbeit in unterschiedlicher
Tiefe. Es ist keine Therapie und ersetzt keine.
...
Bei einfacher Fahrlässigkeit hafte ich nur für die Verletzung wesentlicher
...
du regelmäßig vertrauen darfst. In diesem Fall ist die Haftung auf den
...
ausschließlich den Teilnehmenden zur eigenen Verwendung zur Verfügung und
...
und keiner weltanschaulichen Organisation verpflichtet.

Ich distanziere mich ausdrücklich von Scientology und vergleichbaren
Organisationen und lehne jede Zusammenarbeit mit ihnen oder ihnen
nahestehenden Unternehmen ab. In meinen Programmen wird nicht nach Methoden
