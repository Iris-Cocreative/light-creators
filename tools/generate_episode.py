...
@@BODYCLOSE@@
      <a href="https://light-creators.com/founder" class="plausible-event-name=outbound_lc_founder_click_de btn btn--ghost" target="_blank" rel="noopener">Für Founder Resonance: light-creators.com <span class="arrow">→</span></a>
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a class="plausible-event-name=outbound_lc_founder_click_de" href="https://light-creators.com/founder" target="_blank" rel="noopener">Für Founder Resonance: light-creators.com</a></li>
        </ul>
      </div>
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a class="plausible-event-name=outbound_lc_founder_click_episode" href="https://light-creators.com/founder-en" target="_blank" rel="noopener">Founder Resonance in English →</a></li>
        </ul>
      </div>
    </div>
